    ...
    return (
        <div>
            <div className = "about">
                ...
                <div>
                    <img className = "image" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTWmaIj1Wvug_QDBC4xksU-76Hf2DMF8zZGNA&usqp=CAU" alt="" />
                </div>
            </div>
            <div className = "about">
                <div>
                    <img className = "image" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZ2ki1vdVvySTV0AghunawG6oENXYttU1yRw&usqp=CAU" alt="" />
                </div>
                <div className = "title">
                    <h1>
                        Our Aim
            ...
            <div className = "about">
                ...
                <div>
                    <img className = "image" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTWtNPxKOAW8-haGerUq8kX-lS-e8LEFqj6nw&usqp=CAU" alt="" />
                </div>
            </div>
        </div>
    );
